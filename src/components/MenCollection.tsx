...
const MEN_IDS = ['men-joggers', 'men-triblend', 'men-hoodie', 'men-tee'];

export default function MenCollection({ products, onAddToCart }: MenCollectionProps) {
  const menItems = products.filter(p => MEN_IDS.includes(p.id));

  return (
    <section id="men-collection" className="relative py-20 px-4 md:px-8 bg-brand-pearl overflow-hidden scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="font-display font-bold text-4xl md:text-5xl tracking-tight text-brand-charcoal leading-tight">
            Built Before Sunrise <span className="text-brand-emerald">Men</span>
          </h2>
          <p className="font-sans text-brand-charcoal/70 text-sm leading-relaxed max-w-xl">
            Premium essentials for the modern man. Built for training, recovery, and everyday grind.
          </p>
        </motion.div>
