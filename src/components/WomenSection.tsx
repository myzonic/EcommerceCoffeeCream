...
const WOMEN_IDS = ['womens-leggings', 'womens-crop-top', 'womens-crop-hoodie', 'womens-joggers', 'womens-weekend-hoodie', 'womens-quarterzip', 'womens-tank', 'womens-jogger-set'];

export default function WomenSection({ products, onAddToCart }: WomenSectionProps) {
  const womenItems = products.filter(p => WOMEN_IDS.includes(p.id));

  return (
    <section id="women-section" className="relative py-20 px-4 md:px-8 bg-brand-pearl overflow-hidden scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="font-display font-bold text-4xl md:text-5xl tracking-tight text-brand-charcoal leading-tight">
            Women's <span className="text-brand-emerald">Collection</span>
          </h2>
          <p className="font-sans text-brand-charcoal/70 text-sm leading-relaxed max-w-xl">
            Premium performance apparel designed for women who train, lead, and inspire.
          </p>
        </motion.div>
