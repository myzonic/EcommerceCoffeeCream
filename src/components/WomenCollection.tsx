...
const NAOMI_IDS = ['naomi-leggings', 'naomi-sculpt-shorts', 'naomi-luxe-zip', 'naomi-perf-quarterzip', 'naomi-relaxed-joggers', 'naomi-crop-tee', 'naomi-crop-hoodie', 'naomi-perf-hoodie'];
